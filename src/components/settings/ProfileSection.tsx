  ...
  return (
    <section className="glass-card rounded-3xl p-8">
      <div className="mb-8 flex items-center justify-between">
        ...
        <Button className="rounded-full px-4 text-primary" variant={'outline'}>Edit</Button>
      </div>
      <div className="flex items-center gap-8">
        <div className="group relative">
          <div className="to-tertiary absolute -inset-1 rounded-full bg-gradient-to-tr from-primary opacity-25 blur transition duration-500 group-hover:opacity-50"></div>
          <img
            alt="User avatar"
