...
const PricingSection = () => {
  return (
    <section className="relative overflow-hidden px-6 py-16 sm:py-24" id="pricing">
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        <div className="mb-20 text-center">
          <h2 className="text-on-surface mb-4 text-2xl sm:text-4xl font-extrabold md:text-5xl">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          <div className="bg-card rounded-xl border p-5 sm:p-8 transition-all duration-300">
            ...
            <button className=" w-full rounded-md border py-3 sm:py-4 sm:font-bold">
              Get Started
            </button>
          </div>
          <div className="bg-card relative rounded-xl border-2 border-primary/50 p-5 sm:p-8 backdrop-blur-xl transition-all duration-300">
            ...
            <button className=" bg-primary w-full rounded-md py-3 sm:py-4 sm:font-bold shadow-lg shadow-primary/20">
              Go Pro Now
            </button>
          </div>
          <div className="bg-card rounded-xl border p-5 sm:p-8 transition-all duration-300">
            ...
            <button className=" w-full rounded-md border py-3 sm:py-4 sm:font-bold transition-colors">
              Contact Sales
            </button>
          </div>
        </div>
